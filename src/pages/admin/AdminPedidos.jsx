    ...
    return (
        <div className={styles.detailContent}>
            ...
            <div className={styles.badgesRow}>
                <Badge
                    variant={
                        PAYMENT_STATUS_BADGE[getDisplayPaymentStatus(order.status)] ||
                        "lavender"
                    }
                >
...
export default function AdminPedidos() {
    ...
    const renderOrderCard = (order, mobileMode = false) => {
        ...
        return (
            <Card
                ...
                className={`${styles.orderCard} ${
                    !mobileMode && isSelected ? styles.orderCardSelected : ""
                }`}
            >
                ...
                <div className={styles.actionsRow}>
                    <Button
                        variant={mobileMode ? "primary" : isSelected ? "secondary" : "ghost"}
                        onClick={() =>
                            mobileMode
