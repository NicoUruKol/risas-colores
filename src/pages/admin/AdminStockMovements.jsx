...
const TYPE_OPTIONS = [
    { value: "", label: "Todos" },
    { value: "order_paid", label: "Venta confirmada" },
...
const getTypeLabel = (type) => {
    if (type === "order_paid") return "Venta confirmada";
    if (type === "order_cancel") return "Cancelación";
    return type || "-";
};
            ...
            <Container className={styles.wrap}>
                <header className={styles.head}>
                    <div className={styles.headInfo}>
                        ...
                        <h1 className={styles.title}>Ventas y cancelaciones</h1>
                        <p className={styles.sub}>
                            Historial comercial por producto y talle.
                        </p>
                    </div>
                            ...
                            <div>
                                {items.map((m) => (
                                    <div key={m.id} className={styles.tableRow}>
                                        ...
                                        <div className={styles.tableText}>{getTypeLabel(m.type)}</div>
